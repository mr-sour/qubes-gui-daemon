...
static void x11_win_reparent_to_gtk_csd(void); //static void x11_win_reparent_to_gtk_csd(Window *w);
...
static void x11_win_reparent_to_gtk_csd(void)
{
...
int main(int argc, char **argv)
{
    ...
    /* TODO dont init gtk if non csd window manager */    
    gtk_init(NULL, NULL);
    ...
    for (;;) {
        //non blocking gtk_main TODO skip if not in csd WM
